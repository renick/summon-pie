...
return array(
	...
	'content'    => '<!-- wp:group {"backgroundColor":"secondary","className":"container-fluid section-no-block-space"} -->
					...
					<h2 class="has-text-align-center has-light-color has-text-color">Call To Action</h2>
					<!-- /wp:heading -->
