 ...
 */
return array(
	'title'      => __( 'Latest Posts Section', 'societas' ),
	'categories' => array( 'featured' ),
	'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"50px","right":"0px","bottom":"50px","left":"0px"}}},"backgroundColor":"light","className":"container-fluid","layout":{"inherit":true}} -->
					<div id="latest-posts-section" class="wp-block-group container-fluid has-light-background-color has-background" style="padding-top:50px;padding-right:0px;padding-bottom:50px;padding-left:0px"><!-- wp:group {"className":"container"} -->
