...
return array(
	...
	'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"30px","right":"0px","bottom":"50px","left":"0px"}}},"backgroundColor":"background","className":"border-top","layout":{"inherit":true}} -->
					<div id="upper-footer" class="wp-block-group border-top has-background-background-color has-background" style="padding-top:30px;padding-right:0px;padding-bottom:50px;padding-left:0px"><!-- wp:group -->
					...
					<div id="lower-footer" class="wp-block-group has-tertiary-background-color has-background"><!-- wp:group {"className":"container-fluid p-0 m-0"} -->
					...
					<div class="wp-block-group col col-xs-12"><!-- wp:paragraph {"align":"center","textColor":"background","className":"copyright","fontSize":"small"} -->
					<p class="has-text-align-center copyright has-background-color has-text-color has-small-font-size">Copyright © 2022 <a href="https://xideathemes.com" target="_blank" rel="noreferrer noopener">Xidea Themes</a></p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group --></div>
